        ...
        <div className='container mx-auto'>
            <div className='flex justify-between gap-x-8'>
                ...
                <div className='flex max-w-[600px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left'>
                    <div className='text-sm uppercase font-semibold mb-4 text-primary tracking-[4px]'>Developer</div>
                    <h1 className='h1 mb-4'>Hello, my name is Daniel Seta</h1>
                    <p className='subtitle max-w-[490px] mx-auto xl:mx-0'>Brief description with insights into myself, my vocational journey, and 
                ...
                <div className='hidden xl:flex relative'>
                    ...
                    {/** need to add image  */}
                    <DevImg  containerStyles='bg-hero_shape w-[510px] h-[462] bg-no-repeat relative bg-bottom' imgSrc='/hero/'/>
                </div>
            </div>
            {/* icon */}
